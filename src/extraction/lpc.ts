 ...
 *
 * Kept byte-for-byte in step with `pulse-sdk/src/extraction/lpc.ts`. This file
 * is a deliberate copy, not an import, and the two must compute identical
 * numbers or a wallet enrolled in one client cannot re-verify in the other.
 */
...
export function extractLpcAnalysis(
  ...
  // Pre-allocate the windowed frame buffer once (saves ~1200 Float32Array allocations
