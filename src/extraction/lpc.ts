// PORTED VERBATIM from pulse-sdk/src/extraction/lpc.ts.
// Linear Predictive Coding for formant detection. Levinson-Durbin recursion
// + Durand-Kerner polynomial root-finding. Pure TypeScript, no platform deps.
