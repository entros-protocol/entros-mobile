// PORTED VERBATIM from pulse-sdk/src/extraction/statistics.ts.
// Cross-platform reproducibility (Stage 3) requires bit-identical statistics
// between web and mobile, so this file is kept in sync with the web SDK.
...
/**
 * Shannon entropy over histogram bins.
 */
...
/**
 * Concatenate raw features without normalization. Used for server-side validation.
 */
