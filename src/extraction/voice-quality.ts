 ...
 * that to one build, measured at 8.4x on the whole voice-quality pass.
 *
 ...
 *
 * Kept byte-for-byte in step with `pulse-sdk/src/extraction/voice-quality.ts`.
 * This file is a deliberate copy, not an import, and the two must compute
 * identical numbers or a wallet enrolled in one client cannot re-verify in
 * the other.
 */
let cppBasisKey = "";
