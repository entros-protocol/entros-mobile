  ...
  return (
    <Screen scroll>
      ...
      <GlowCard glow style={styles.scoreCard}>
        ...
        <Text style={[styles.scoreValue, { color: palette.text, fontFamily: fontFamily.bold }]}>
          {identity.hasAnchor ? identity.trustScore : "—"}
          <Text variant="title" tone="muted">
            {identity.hasAnchor ? " / 100" : ""}
          </Text>
        </Text>
        ...
        <Text variant="body" tone="muted">
          {identity.hasAnchor
            ? identity.trustScore === 0
              ...
              : "Re-verify regularly to keep your score active."
        ...
        <Button
          ...
          iconLeft={
            identity.hasAnchor ? (
              <RefreshIcon color={palette.background} size={16} />
            ) : (
              <SparkleIcon color={palette.background} size={16} />
            )
          }
        />
      </GlowCard>
